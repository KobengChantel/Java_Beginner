...
//the car wash application that uses this technique to prevent fall-
//throughs in the switch statement. (Using simple fall-throughs to treat uppercase
//and lowercase characters the same way isn’t as confusing, so this program still
//uses that technique.)
